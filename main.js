const messages = {
    en: {
        ...
        advantages: {
            ...
            item_3: 'Have the spirit of Geek, love open source, there are many open source projects on GitHub',
            item_4: 'Good English, accessible English documents',
            item_5: 'Skilled collaboration, no stress writing technical documentation, project documentation'
        },
        experience: {
            item_1: {
                job_company: 'Kakabuy',
        ...
        skills: {
            item_1: 'Web Development: PHP/TypeScript/Node',
        ...
        activities: {
            ...
            item_2: {
                ...
                title: 'Society',
                time: 'Sept. 2014 - Oct. 2016',
                description: 'Responsible for participating in various levels of programming competitions on behalf of the school, including ACM, CCPC, Lan Qiao Programming Contest and so on.'
            }
        },
        adwards: {
            item_1: {
